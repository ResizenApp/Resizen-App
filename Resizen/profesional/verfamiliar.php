        ...
        <?php
            ...
            <div id='formulario'>
                <form>
                    ...
                    Telefono de contacto: <input type='tel' id='telefono' name='telefono' value='". $datos['tel_contac']."' readonly='readonly'><br><br>
                </form>
                <button onclick='atrasfamiliar()'>Atras</button><br><br>
            </div>
            ");
        ?>
    </body>
